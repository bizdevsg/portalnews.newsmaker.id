        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @php
                $cards = [
                    ...
                    [
                        'title' => 'Jumlah Admin',
                        'count' => ($widget['admin'] ?? '0') . ' Admin',
                        'icon' => 'fa-users',
                        'color' => '#10B981',
                        'link' => route('user.index'),
                    ],
                    [
                        'title' => 'Jumlah Superadmin',
                        'count' => ($widget['superadmin'] ?? '0') . ' Superadmin',
                        'icon' => 'fa-user-shield',
                        'color' => '#8B5CF6',
                        'link' => route('user.index'),
                    ],
            ...
            @foreach ($cards as $card)
                <a href="{{ $card['link'] }}"
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <h2 class="font-bold text-2xl text-gray-900 dark:text-white leading-none">{{ $card['count'] }}
                        </h2>
                    </div>
                </a>
            @endforeach
