@section('namePage', 'Edit Kategori Berita Pasar Indonesia')

<x-app-layout>
    <form action="{{ route('pasar-indonesia.berita.kategori.update', $category->id) }}" method="POST" class="w-full px-4 py-8 sm:px-6 lg:px-8">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6 xl:grid-cols-[1.1fr_0.9fr]">
                <div class="space-y-2">
                    ...
                    <p class="text-sm leading-6 text-slate-500 dark:text-slate-400">
                        Nama ini akan tampil pada daftar kategori dan detail berita Pasar Indonesia.
                    </p>
                </div>
