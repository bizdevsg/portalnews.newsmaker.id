@section('namePage', 'Tambah Category Kalender')
        ...
        <form action="{{ route('calendar.store') }}" method="POST"
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-5 flex items-center justify-between gap-4">
                <div>
                    ...
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Category Header</h1>
                </div>
            ...
            <div class="p-6">
                @include('calendar.partials.category-fields', ['calendar' => null])
            </div>
        </form>
    </div>
</x-app-layout>
