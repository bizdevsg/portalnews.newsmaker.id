                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-5 xl:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input type="text" id="author_display" value="{{ $item->author?->name ?? '-' }}" class="w-full cursor-not-allowed rounded-2xl border border-slate-300 bg-slate-100 px-4 py-3 text-slate-700 outline-none dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200" readonly>
                        ...
                        <div class="xl:col-span-3">
                            ...
                            <label for="notif" class="inline-flex items-center gap-2 cursor-pointer">
                                ...
                                <span class="text-sm font-semibold text-slate-900 dark:text-slate-100">Kirim Notifikasi ke API</span>
                            </label>
                            @error('notif')
                                <p class="mt-2 text-sm font-medium text-rose-600 dark:text-rose-300">{{ $message }}</p>
                            @enderror
