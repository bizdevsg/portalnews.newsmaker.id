@section('namePage', 'Tambah Main Category')
...
<x-app-layout>
    ...
    <div class="nm23 px-4 sm:px-6 lg:px-8 py-8 w-full max-w-4xl mx-auto">
            ...
            <div class="flex flex-wrap items-start justify-between gap-6">
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <h1 class="nm-title text-3xl sm:text-4xl">Main Category Baru</h1>
                        <p class="text-sm sm:text-base text-blue-100 max-w-xl">
                            Buat main category untuk mengelompokkan sub category dan berita.
                        </p>
                    </div>
                </div>
        ...
        <form id="mainForm" action="{{ route('newsmaker23.main-category.store') }}" method="POST" class="mt-8">
            @csrf
            <div class="nm-card p-6 space-y-4">
                <div class="nm-field space-y-2">
                    <label for="name">Nama Main Category</label>
                    <input type="text" id="name" name="name" value="{{ old('name') }}" class="nm-input @error('name') border-red-500 @enderror" placeholder="Masukkan nama main category..." required>
