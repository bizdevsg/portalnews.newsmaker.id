@section('namePage', 'Edit Category Kalender')

<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full mx-auto">
        <form action="{{ route('calendar.update', $calendar) }}" method="POST"
            ...
            <div class="border-b border-gray-200 dark:border-gray-700 px-6 py-5 flex items-center justify-between gap-4">
                <div>
                    ...
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Category Header</h1>
                </div>
            ...
            <div class="p-6">
                @include('calendar.partials.category-fields', ['calendar' => $calendar])
            </div>
        </form>
    </div>
</x-app-layout>
