@section('namePage', 'Tambah Video Briefing Newsmaker23')
...
<x-app-layout>
    <div class="w-full px-4 py-8 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('newsmaker23.video-briefing.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
                ...
                <div class="flex flex-wrap items-start justify-between gap-6">
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <h1 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">Buat Video Briefing</h1>
                            <p class="text-sm leading-6 text-blue-100 sm:text-base">
                                Simpan judul dan embed code untuk ditampilkan pada modul Video Briefing.
                            </p>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
                    <div class="xl:col-span-1">
                        ...
                        <p class="mt-2 text-sm leading-6 text-slate-500 dark:text-slate-400">
                            Embed code wajib diisi. Backup URL bersifat opsional jika ingin menyediakan fallback.
                        </p>
                    </div>
                    ...
                    <div class="space-y-5 xl:col-span-2">
                        ...
                        <div>
                            ...
                            <textarea id="embed_code" name="embed_code" rows="8"
                                ...
                                placeholder="Tempel embed code di sini..." required>{{ old('embed_code') }}</textarea>
                            @error('embed_code')
                                <p class="mt-2 text-sm font-medium text-rose-600 dark:text-rose-300">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input id="backup_video_url" name="backup_video_url" type="url" value="{{ old('backup_video_url') }}"
