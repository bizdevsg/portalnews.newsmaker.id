        ...
        <div class="flex gap-4 flex-col lg:flex-row">
            ...
            <div
                ...
                <div>
                    ...
                    <div class="@if(strtolower($calendar->impact) === 'high') text-red-800 dark:text-red-400
                            @elseif(strtolower($calendar->impact) === 'medium') text-yellow-600 dark:text-yellow-400
                            @elseif(strtolower($calendar->impact) === 'low') text-green-600 dark:text-green-400
                            @endif">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-2">
                        @php
                        $currencyToCountry = [
                        'US' => 'US', 'EUR' => 'EU', 'JPY' => 'JP', 'GBP' => 'GB',
                        'AUD' => 'AU', 'CAD' => 'CA', 'CHF' => 'CH', 'CHN' => 'CN',
                        'HKD' => 'HK', 'IDN' => 'ID',
                        ];
                ...
                $actualBg = $actual > $previous ? 'bg-green-100 dark:bg-green-900' : ($actual < $previous
                    ? 'bg-red-100 dark:bg-red-900' : 'bg-gray-100 dark:bg-gray-700' ); } @endphp <div
        ...
        <div class="rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
            <table class="min-w-full table-auto bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
                ...
                <tbody>
                    ...
                    @else
                    <tr>
                        <td class="border border-gray-200 dark:border-gray-700 px-4 py-2 text-center" colspan="4">
