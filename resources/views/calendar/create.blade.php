            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="form-group flex flex-col gap-2">
                    ...
                    <textarea name="bankHolidayNote" id="bankHolidayNote" rows="2"
                        ...
                        class="rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 px-3 py-2 focus:outline-none focus:ring focus:border-blue-500">{{ old('bankHolidayNote') }}</textarea>
                </div>
