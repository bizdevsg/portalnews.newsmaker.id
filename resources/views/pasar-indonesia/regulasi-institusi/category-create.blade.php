@section('namePage', 'Tambah Kategori Regulasi & Institusi')

<x-app-layout>
    <form action="{{ route('regulasi-institusi.kategori.store') }}" method="POST" class="w-full px-4 py-8 sm:px-6 lg:px-8">
        @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm leading-6 text-blue-100 sm:text-base">
                            Tambahkan Kategori Regulasi & Institusi untuk mengelompokkan artikel dengan lebih rapi.
                        </p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 gap-6 xl:grid-cols-[1.1fr_0.9fr]">
                <div class="space-y-2">
                    ...
                    <p class="text-sm leading-6 text-slate-500 dark:text-slate-400">
                        Nama kategori akan dipakai sebagai struktur utama untuk Berita Regulasi & Institusi.
                    </p>
                </div>
