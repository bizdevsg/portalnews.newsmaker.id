...
<div class="relative inline-flex" x-data="{ open: false }">
    <button class="inline-flex justify-center items-center gap-2 group cursor-pointer" aria-haspopup="true"
        ...
        <ul>
            ...
            <li>
                <form method="POST" action="{{ route('logout') }}" x-data>
                    ...
                    <a class="font-medium text-sm text-red-500 hover:text-red-600 dark:hover:text-red-400 flex items-center py-1 px-3"
