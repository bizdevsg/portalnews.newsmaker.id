@section('namePage', 'Edit Kategori Newsmaker23')

<x-app-layout>
    <form action="{{ route('newsmaker23.main-category.update', $category->id) }}" method="POST" class="w-full px-4 py-8 sm:px-6 lg:px-8">
        @csrf
        @method('PUT')
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm leading-6 text-indigo-100 sm:text-base">
                            Ubah kategori <span class="font-semibold text-white">{{ $category->name }}</span> agar struktur konten tetap relevan.
                        </p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 gap-6 xl:grid-cols-[1.1fr_0.9fr]">
                <div class="space-y-2">
                    ...
                    <p class="text-sm leading-6 text-slate-500 dark:text-slate-400">
                        Nama ini akan tampil sebagai struktur utama pada dashboard, daftar kategori, dan daftar berita.
                    </p>
                </div>
