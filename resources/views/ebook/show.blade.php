    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-7xl mx-auto">
        <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="flex flex-col md:flex-row gap-6">
                {{-- Cover Image --}}
                <div class="w-full max-w-[300px] aspect-[3/4.5] rounded overflow-hidden shadow">
                ...
                <div class="flex-1 space-y-4">
                    {{-- Header --}}
                    <h1 class="text-2xl font-bold mb-4 text-center md:text-left">{{ $ebook->judul }}</h1>

                    <p class="text-gray-700 whitespace-pre-line text-justify">{{ $ebook->deskripsi }}</p>
                        ...
                        <div x-data="{ showModal: false }" class="flex-1">
                            ...
                            <div x-show="showModal" x-cloak
                                ...
                                <div @click.away="showModal = false"
                                    ...
                                    <p class="text-gray-700 mb-6">Apakah Anda yakin ingin menghapus e-Book <strong>{{
                                            $ebook->judul }}</strong>?</p>
