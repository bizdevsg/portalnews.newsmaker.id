@section('namePage', 'Tambah Kategori Berita Pasar Indonesia')

<x-app-layout>
    <form action="{{ route('pasar-indonesia.berita.kategori.store') }}" method="POST" class="w-full px-4 py-8 sm:px-6 lg:px-8">
        @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm leading-6 text-blue-100 sm:text-base">
                            Tambahkan kategori berita Pasar Indonesia untuk mengelompokkan artikel dengan lebih rapi.
                        </p>
                    </div>
                </div>

                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('pasar-indonesia.berita.index') }}" class="inline-flex items-center justify-center rounded-xl border border-white/15 bg-white/5 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/10">
                        Kembali
                    </a>
            ...
            <div class="grid grid-cols-1 gap-6 xl:grid-cols-[1.1fr_0.9fr]">
                <div class="space-y-2">
                    ...
                    <p class="text-sm leading-6 text-slate-500 dark:text-slate-400">
                        Nama kategori akan dipakai sebagai struktur utama untuk berita Pasar Indonesia.
                    </p>
                </div>
