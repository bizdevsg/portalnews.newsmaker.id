...
<x-app-layout>
    ...
    <form id="newsForm" action="{{ route('newsmaker23.berita.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm leading-6 text-blue-100 sm:text-base">
                            Anda sedang menambahkan berita ke kategori {{ $selectedMainCategory->name }}. Lengkapi meta
